...
export interface CancelableEventFilter<Args extends any[] = any[], This = any, Invoke extends AnyFn = AnyFn> {
  (_: Invoke, _: FunctionWrapperOptions<Args, This>): ReturnType<Invoke> | Promisify<ReturnType<Invoke>>;
  cancel: () => void;
  flush: () => void;
...
export declare function createFilterWrapper<T extends AnyFn>(_: CancelableEventFilter, _: T): CancelablePromisifyFn<T>;
export declare function createFilterWrapper<T extends AnyFn>(_: EventFilter, _: T): PromisifyFn<T>;
export declare function createGlobalState<Fn extends AnyFn>(_: Fn): CreateGlobalStateReturn<Fn>;
export declare function createInjectionState<Arguments extends Array<any>, Return>(_: (..._: Arguments) => Return, _: {
  defaultValue: Return;
...
export declare function debounceFilter(_: MaybeRefOrGetter<number>, _?: DebounceFilterOptions): CancelableEventFilter;
export declare function extendRef<R extends Ref<any>, Extend extends object, Options extends ExtendRefOptions<false>>(_: R, _: Extend, _?: Options): ShallowUnwrapRef$1<Extend> & R;
...
export declare function get<T>(_: MaybeRef<T>): T;
...
export declare function reactifyObject<T extends object, Keys extends keyof T>(_: T, _?: (keyof T)[]): ReactifyObjectReturn<T, Keys, true>;
...
export declare function reactiveOmit<T extends object, K extends keyof T>(_: T, ..._: (K | K[])[]): ReactiveOmitReturn<T, K>;
export declare function reactiveOmit<T extends object>(_: T, _: ReactiveOmitPredicate<T>): ReactiveOmitReturn<T>;
export declare function reactivePick<T extends object, K extends keyof T>(_: T, ..._: (K | K[])[]): ReactivePickReturn<T, K>;
...
export declare function toRef<T>(_: () => T): Readonly<Ref<T>>;
export declare function toRef<T>(_: ComputedRef<T>): ComputedRef<T>;
export declare function toRef<T>(_: MaybeRefOrGetter<T>): Ref<T>;
export declare function toRef<T>(_: T): Ref<T>;
export declare function toRef<T extends object, K extends keyof T>(_: T, _: K): ToRef<T[K]>;
...
export declare function until<T extends unknown[]>(_: WatchSource<T> | MaybeRefOrGetter<T>): UntilArrayInstance<T>;
export declare function until<T>(_: WatchSource<T> | MaybeRefOrGetter<T>): UntilValueInstance<T>;
export declare function useArrayDifference<T>(_: MaybeRefOrGetter<T[]>, _: MaybeRefOrGetter<T[]>, _?: keyof T, _?: UseArrayDifferenceOptions): UseArrayDifferenceReturn<T>;
...
export declare function useArrayFilter<T, S extends T>(_: MaybeRefOrGetter<MaybeRefOrGetter<T>[]>, _: (_: T, _: number, _: T[]) => element is S): UseArrayFilterReturn<S>;
...
export declare function useArrayIncludes<T, V = any>(_: MaybeRefOrGetter<MaybeRefOrGetter<T>[]>, _: MaybeRefOrGetter<V>, _?: UseArrayIncludesComparatorFn<T, V>): UseArrayIncludesReturn;
export declare function useArrayIncludes<T, V = any>(_: MaybeRefOrGetter<MaybeRefOrGetter<T>[]>, _: MaybeRefOrGetter<V>, _?: keyof T): UseArrayIncludesReturn;
...
export declare function useArrayReduce<T>(_: MaybeRefOrGetter<MaybeRefOrGetter<T>[]>, _: UseArrayReducer<T, T, T>): UseArrayReduceReturn<T>;
...
export declare function useToggle<Truthy, Falsy, T = Truthy | Falsy>(_: Ref<T>, _?: UseToggleOptions<Truthy, Falsy>): (_?: T) => T;
...
export declare function watchDebounced<T, Immediate extends Readonly<boolean> = false>(_: WatchSource<T>, _: WatchCallback<T, Immediate extends true ? T | undefined : T>, _?: WatchDebouncedOptions<Immediate>): WatchHandle;
export declare function watchDebounced<T extends Readonly<MultiWatchSources$1>, Immediate extends Readonly<boolean> = false>(_: [...T], _: WatchCallback<MapSources<T>, MapOldSources<T, Immediate>>, _?: WatchDebouncedOptions<Immediate>): WatchHandle;
...
export declare function watchDeep<T, Immediate extends Readonly<boolean> = false>(_: WatchSource<T>, _: WatchCallback<T, Immediate extends true ? T | undefined : T>, _?: Omit<WatchOptions<Immediate>, 'deep'>): WatchHandle;
export declare function watchDeep<T extends Readonly<MultiWatchSources$1>, Immediate extends Readonly<boolean> = false>(_: [...T], _: WatchCallback<MapSources<T>, MapOldSources<T, Immediate>>, _?: Omit<WatchOptions<Immediate>, 'deep'>): WatchHandle;
...
export declare function watchIgnorable<T, Immediate extends Readonly<boolean> = false>(_: WatchSource<T>, _: WatchCallback<T, Immediate extends true ? T | undefined : T>, _?: WatchWithFilterOptions<Immediate>): WatchIgnorableReturn;
export declare function watchIgnorable<T extends Readonly<MultiWatchSources$1>, Immediate extends Readonly<boolean> = false>(_: [...T], _: WatchCallback<MapSources<T>, MapOldSources<T, Immediate>>, _?: WatchWithFilterOptions<Immediate>): WatchIgnorableReturn;
...
export declare function watchImmediate<T>(_: WatchSource<T>, _: WatchCallback<T, T | undefined>, _?: Omit<WatchOptions<true>, 'immediate'>): WatchHandle;
export declare function watchImmediate<T extends Readonly<MultiWatchSources$1>>(_: [...T], _: WatchCallback<MapSources<T>, MapOldSources<T, true>>, _?: Omit<WatchOptions<true>, 'immediate'>): WatchHandle;
...
export declare function watchTriggerable<T, FnReturnT>(_: WatchSource<T>, _: WatchTriggerableCallback<T, T | undefined, FnReturnT>, _?: WatchWithFilterOptions<boolean>): WatchTriggerableReturn<FnReturnT>;
export declare function watchTriggerable<T extends Readonly<MultiWatchSources$1>, FnReturnT>(_: [...T], _: WatchTriggerableCallback<MapSources<T>, MapOldSources<T, true>, FnReturnT>, _?: WatchWithFilterOptions<boolean>): WatchTriggerableReturn<FnReturnT>;
...
export declare function watchWithFilter<T, Immediate extends Readonly<boolean> = false>(_: WatchSource<T>, _: WatchCallback<T, Immediate extends true ? T | undefined : T>, _?: WatchWithFilterOptions<Immediate>): WatchHandle;
export declare function watchWithFilter<T extends Readonly<MultiWatchSources$1>, Immediate extends Readonly<boolean> = false>(_: [...T], _: WatchCallback<MapSources<T>, MapOldSources<T, Immediate>>, _?: WatchWithFilterOptions<Immediate>): WatchHandle;
...
export declare function whenever<T>(_: WatchSource<T>, _: WatchCallback<Truthy<T>, T | undefined>, _?: WheneverOptions<true>): WatchHandle;
