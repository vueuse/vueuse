...
const { vertices, edges } = useRectangle({ width, height, center, rotation })
</script>
  ...
  <div>
    ...
    <div class="mt-4 control-area">
      ...
      <div class="control-group">
        <label class="mr-2">Width: <span>{{ width }}</span></label>
        <input v-model="width" class="slider" type="range" min="0" max="500">
      </div>
      <div class="control-group">
