...
<template>
  <div>
    ...
    <div class="w-300px mt-10px px-6 py-4 rounded grid grid-cols-[120px,auto] gap-2 bg-gray-500/5">
      ...
      <BooleanDisplay :value="noneSelected" />
      <div text="right" opacity="75">
        allSelected
      </div>
      <BooleanDisplay :value="allSelected" />
      <div text="right" opacity="75">
        partiallySelected
      </div>
