...
const filesData = ref<{ name: string; size: number; type: string }[]>([])
...
<template>
  <div class="flex">
    <div class="w-full h-auto relative">
      ...
      <div class="flex flex-col w-full min-h-200px h-auto bg-gray-400/10 justify-center items-center mt-6" v-on="handlers">
