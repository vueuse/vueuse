...
export function useStorage<T = unknown>(key: string, defaults?: MaybeRefOrGetter<null | undefined>, storage?: StorageLike, options?: UseStorageOptions<T>): RemovableRef<T>
