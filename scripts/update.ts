...
import { readIndexes, updateFunctionREADME, updateFunctionsMD, updateImport, updateIndexREADME, updatePackageIndexMD, updatePackageJSON, updatePackageREADME } from './utils'
...
async function run() {
  ...
  await updatePackageIndexMD(indexes)
